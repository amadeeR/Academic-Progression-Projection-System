...
progression_outcome = ''
progression_list = []
progression_data_file = open("progressiondatafile.txt","w")
...
def staff_progression():
    ...
    while True:
        ...
        #Part_3 #Appending text file with progression outcomes and credit values
        progression_data_file = open("progressiondatafile.txt","a")
        progression_data_file.write(f"{progression_outcome} - {pass_credit},{defer_credit},{fail_credit}\n")
        progression_data_file.close()
...
def staff_start():
    while True:
        ...
        if staff_input == 'y':
            ...
            print()
            print("Part 3: ")
            progression_data_file = open("progressiondatafile.txt","r") #Part_3 contd- Displaying progression outcomes and credit values stored in the text file 
            print(progression_data_file.read())
            print()
            progression_data_file.close() 
